...
import { createDiseases } from "../graphql/mutations";
...
export default function DiseasesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSelfcare(initialValues.selfcare);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDiseases.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DiseasesCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
